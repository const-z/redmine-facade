    ...
    function pageScripts() {
        ...
        (function () {
            function animateElements() {
                $('.progressbar').each(function () {
                    ...
                    var figure = circle ? circle : line;
                    var percent = figure.attr('data-percent');
                    var percentage = parseInt(percent, 10) / parseInt(100, 10);
                    var mainColor = figure.attr('main-color');
                    mainColor = mainColor ? mainColor : "#ffffff";
        ...
        (function () {
            ...
            function initGmap() {
                ...
                console.log(lat);
                console.log(lng);
                // var $latlng = new google.maps.LatLng(55.751244, 37.618423),
